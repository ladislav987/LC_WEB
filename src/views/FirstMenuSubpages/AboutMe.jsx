    ...
    <>
      ...
      <main className="container_aboutMe">
        ...
        <div className="skuska">
          <h3 className="skuska_grid1_1">Osobné údaje</h3>
          <section className="udaje">
            <div className="grid_15_85">
              <span className="grid1_1 skuska_grid1_2">
                <BsFillPersonFill size="1.8em" />
              </span>
              <p className="grid2_1 skuska_grid2_2">Ladislav Chvastaš</p>
            </div>
            <div className="grid_15_85">
              <span className="grid1_1">
                <GrMail size="1.8em" />
          ...
          <section className="zaujmy">
            <div className="container_hobbies">
              <div className="grid_25_25_25_25">
                <span className="grid1_1 skuska_grid5_1">
